    ...
    <div className="hidden lg:flex flex-col top-[35%] left-0 fixed z-50">
      <ul>
        {links.map(({ id, child, href, style, download }) => (
          <li
            key={id}
            className={`flex justify-between items-center w-44 h-14 px-4 ml-[-110px] hover:ml-[-10px] duration-300 bg-gray-500 dark:bg-gray-700 text-white hover:rounded-md ${style}`}
          >
            <a
              href={href}
